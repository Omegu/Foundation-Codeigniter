...
<html class="no-js" lang="en">
  <head>
    ...
    <link href="<?php echo base_url('assets/css/foundation.css')?>" rel="stylesheet" type="text/css"/>
  </head>
  <body>
    ...
    <script src="<?php echo base_url('assets/js/vendor/foundation.js')?>" type="text/javascript"></script>
